...
Usage:
    ...
    5. Create custom directory structures:
       ...
       `create_directories({'/kaggle/input': ['models', 'output']}, quiet=False)`
    ...
    7. Compress files into a ZIP archive:
       ...
       `zip_files(['file1.csv', 'file2.csv'], 'my_archive.zip', '/kaggle/input', quiet=False)`

    8. Extract a ZIP archive into a directory:

       `unzip_file('my_archive.zip', '/kaggle/input', quiet=False)`
...
def create_directories(dir_structure: dict[str, list[str]], quiet: bool = False) -> None:
    ...
    Example:
        dir_structure = {
            '/kaggle/working': ['temp', 'output'],
            '/kaggle/input': ['data', 'models']
        }
    """
...
def zip_files(files: list[str], zip_name: str, src_dir: str = '/kaggle/input', quiet: bool = False) -> None:
    """
    ...
    Args:
        ...
        src_dir (str): Source directory where the files are located. Defaults to '/kaggle/input'.
        quiet (bool): If True, suppresses output. Defaults to False.
    """
...
def unzip_file(zip_file: str, extract_dir: str = '/kaggle/input', quiet: bool = False) -> None:
    """
    Extract a ZIP file into the specified directory.

    Args:
        zip_file (str): The ZIP file to extract.
        extract_dir (str): The directory to extract the contents. Defaults to '/kaggle/input'.
        quiet (bool): If True, suppresses output. Defaults to False.
    """
